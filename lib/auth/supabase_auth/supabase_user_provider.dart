...
class V3PromcoserSupabaseUser extends BaseAuthUser {
  V3PromcoserSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> v3PromcoserSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = V3PromcoserSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
