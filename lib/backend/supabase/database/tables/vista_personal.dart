...
class VistaPersonalTable extends SupabaseTable<VistaPersonalRow> {
  @override
  String get tableName => 'vista_personal';

  @override
  VistaPersonalRow createRow(Map<String, dynamic> data) =>
      VistaPersonalRow(data);
}

class VistaPersonalRow extends SupabaseDataRow {
  VistaPersonalRow(super.data);

  @override
  SupabaseTable get table => VistaPersonalTable();
