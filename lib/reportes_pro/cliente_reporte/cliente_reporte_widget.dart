...
import 'cliente_reporte_model.dart';
export 'cliente_reporte_model.dart';

class ClienteReporteWidget extends StatefulWidget {
  const ClienteReporteWidget({super.key});

  @override
  State<ClienteReporteWidget> createState() => _ClienteReporteWidgetState();
}

class _ClienteReporteWidgetState extends State<ClienteReporteWidget> {
  late ClienteReporteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClienteReporteModel());
              ...
              children: [
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await launchURL(
                          'https://docs.google.com/spreadsheets/d/e/2PACX-1vQ92p80IROwl_iM4GXPEsTGkrPIo1QLzk2QIicZgH5HgGmijaddnKYNyHpd71wlelHCtGdPhn8FMy3H/pub?gid=709618126&single=true&output=pdf');
                      var confirmDialogResponse = await showDialog<bool>(
                            context: context,
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                content: const Text('Se descrgó satisfactoriamente'),
                                actions: [
                                  TextButton(
